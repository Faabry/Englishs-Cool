...
ELEMENTS = {
    "animals":
        ["Elephant", "Snake", "Dog", "Cat",   "Fish", "Bird",   "Mouse", "Aligator", "pig", "turtle", "bat", "tiger", "butterfly", "dog"],        
    "places":
        ["Park", "Supermarket", "Mall", "Restaurant", "Movies",      "Church", "School", "Work", "Party", "Library",
        "Gas Station", "Bus Stop", "House"],           
    "food":
        ["Pasta", "Meat", "Ham", "Cheese", "Burger", "Pizza",
         "Ice Cream", "Chocolate", "Vegetables", "Bread",
         "Bacon", "French Fries", "Hot Dog", "sushi", "egg", "meatball"],        
    "fruits":
        ["Pear", "Apple", "Banana", "Orange", "Grape", "Lemon", "Passion Fruit", "Watermelon", "Melon", "Pineapple",
        "Papaya", "Coconut", "Kiwi", "Mango", "avocado"],           
    "drinks":
        ["water", "soda", "coffee", "tea", "wine", "juice", "hot chocolate", "milk", "beer"],           
    "objects":
        ["car", "motorcycle", "cellphone","pen", "drums",
